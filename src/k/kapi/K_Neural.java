...
class K_Dlc {
    ...
    static class Encoder_Decoder {
        ...
        Encoder_Decoder(int[] enc_sizes, String[] enc_layer_types, int[] dec_sizes, String[] dec_layer_types, String dense_act_fn1, String dense_act_fn2) {

            this.encoder = K_Api.Generate_Generic_Model(enc_sizes,enc_layer_types,dense_act_fn1);
            this.decoder = K_Api.Generate_Generic_Model(dec_sizes,dec_layer_types,dense_act_fn2);
