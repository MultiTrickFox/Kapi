...
package RootBeer.syr.pcpratts.rootbeer;

import RootBeer.syr.pcpratts.rootbeer.compiler.RootbeerClassLoader;
import RootBeer.syr.pcpratts.rootbeer.compiler.*;
import RootBeer.syr.pcpratts.rootbeer.generate.opencl.tweaks.CudaTweaks;
import RootBeer.syr.pcpratts.rootbeer.generate.opencl.tweaks.NativeCpuTweaks;
import RootBeer.syr.pcpratts.rootbeer.generate.opencl.tweaks.Tweaks;
import RootBeer.syr.pcpratts.rootbeer.util.JarEntryHelp;
import RootBeer.syr.pcpratts.rootbeer.util.JimpleWriter;
import java.io.File;
...
public class RootbeerCompiler {
  ...
  private void addConfigurationFile(ZipOutputStream zos) throws IOException {
    String name = "RootBeer/syr/pcpratts/rootbeer/runtime/config.txt";
