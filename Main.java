public class Main {
    ...
    public static void main(String[] args) {
        ...
        K_tensor node_test = K_tensor.sigm(t_w1);
        K_tensor.fill_grads(node_test);
        System.out.println("node test:  " + node_test.matrix[0][0] + " " + t_w1.grad[0][0] + " " + t_w2.grad[0][0]);
        ...
        System.out.println("node out " + t_w1.grad[0][0] + " " + t_w2.grad[0][0]);
        K_tensor.empty_grads();


        K_tensor node_out_gated = K_tensor.sigm(node_out);
        K_tensor.fill_grads(node_out_gated);
        System.out.println("node out gated " + t_w1.grad[0][0] + " " + t_w2.grad[0][0]);
        K_tensor.empty_grads();
